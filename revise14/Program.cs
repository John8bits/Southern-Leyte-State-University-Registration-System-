                        ...
                        if (AskShift == "y" || AskShift == "Y")
                        {
                            ...
                            for (int k = 0; k < x; k++)
                            {
                                ...
                                MCCOURSE:
                                    ...
                                    {
                                        break;
                                    }else if (course[s].Equals(course[k],StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        Console.WriteLine("Current course must not match the updated course");
                                        goto MCCOURSE;
                                    }
                                    else
                                    {
