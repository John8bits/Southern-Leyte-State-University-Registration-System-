    ...
    public static class Program
    {
        ...
        static void Register()
        {
                ...
                */
                ...
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        {
                            Console.ForegroundColor = ConsoleColor.Red;
                            Console.WriteLine("\n\t\tContact number must not exceed 10 characters\n");
                            Console.ResetColor();
                        }
                        else if (ConvertContact.Length < required.Length)
                        {
                            Console.ForegroundColor = ConsoleColor.Red;
                            Console.WriteLine("\n\t\tContact number must not lesser than 10 characters\n");
                            Console.ResetColor();
                        }
                        else
                        {
                ...
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        {
                            Console.ForegroundColor = ConsoleColor.Red;
                            Console.WriteLine("\n\t\tAge must be greater than 17 && less than 60\n");
                            Console.ResetColor();
                        }
            ...
            y:
                ...
                {
                    Console.ForegroundColor = ConsoleColor.Red;
                    Console.WriteLine("\n\t\tInvalid input! Year must be number\n");
                    Console.ResetColor();
                    goto y;
                }
            ...
            c:
                ...
                MCCOURSE:
                    ...
                    {
                        Console.ForegroundColor = ConsoleColor.Red;
                        Console.WriteLine("\n\t\tNot available course for Main Campus (Sogod)\n");
                        Console.ResetColor();
                        goto MCCOURSE;
                    }
                ...
                HCCOURSE:
                    ...
                    {
                        Console.ForegroundColor = ConsoleColor.Red;
                        Console.WriteLine("\n\t\tNot available course for Hinunangan Campus\n");
                        Console.ResetColor();
                        goto HCCOURSE;
                    }
                ...
                TOCOURSE:
                    ...
                    {
                        Console.ForegroundColor = ConsoleColor.Red;
                        Console.WriteLine("\n\t\tNot available course for Tomas Oppus Campus\n");
                        Console.ResetColor();
                        goto TOCOURSE;
                    }
                ...
                SJCOURSE:
                    ...
                    {
                        Console.ForegroundColor = ConsoleColor.Red;
                        Console.WriteLine("\n\t\tNot available course for San Juan Campus\n");
                        Console.ResetColor();
                        goto SJCOURSE;
                    }
                ...
                MaasinCOURSE:
                    ...
                    {
                        Console.ForegroundColor = ConsoleColor.Red;
                        Console.WriteLine("\n\t\tNot available course for Maasin City Campus\n");
                        Console.ResetColor();
                        goto MaasinCOURSE;
                    }
        ...
        static void ViewRegisteredStudents()
        {
            ...
            else
            {
                ...
                for (int i = 0; i < x; i++)
                {
                    Console.WriteLine("║{0,-27} {1,-27} {2,-27} {3,12}     ║", FullName[i], course[i] , campus[i]+ " Campus", Address[i]);
                    Console.WriteLine("╚═════════════════════════════════════════════════════════════════════════════════════════════════════╝");
                }
                    ...
                    i:
                        ...
                        if (AskShift == "y" || AskShift == "Y")
                        {
                            ...
                            for (int k = 0; k < x; k++)
                            {
                                ...
                                if (campus[s].Equals("Main", StringComparison.InvariantCultureIgnoreCase) || campus[k].Equals("Sogod", StringComparison.InvariantCultureIgnoreCase))
                                {
                                ...
                                MCCOURSE:
                                    ...
                                    course[s] = Console.ReadLine();
                                        ...
                                        if (course[s].Equals(OldCourse, StringComparison.InvariantCultureIgnoreCase))
                                        {
                                        Console.ForegroundColor= ConsoleColor.Red;
                                            Console.WriteLine("\n\t\t\tInvalid input! course matched.\n");
                                        Console.ResetColor();
                                            goto MCCOURSE;
                                        }
                                    

                                    if (course[s].Equals("Information Technology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Industrial Technology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Technology and Livelihood Education", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Industrial Technology", StringComparison.InvariantCultureIgnoreCase))
                                    ...
                                    else if (course[s].Equals("Elementary Education", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Civil Engineering", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Computer Engineering", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Criminology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Electrical Engineering", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Food Technology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Tourism Management", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else
                                ...
                                //hinunangan campus
                                else if (campus[s].Equals("Hinunangan", StringComparison.InvariantCultureIgnoreCase))
                                {
                                ...
                                HCCOURSE:
                                    ...
                                    else if (course[s].Equals("Agricultural Technology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Secondary Education", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Technology and Livelihood Education", StringComparison.InvariantCultureIgnoreCase))
                                    ...
                                    else if (course[s].Equals("Agribusiness", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Agriculture", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Agricultural Entrepreneurship", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Environmental Science", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Information Technology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else
                                ...
                                //TO CAMPUS
                                else if (campus[s].Equals("Tomas Oppus", StringComparison.InvariantCultureIgnoreCase))
                                {
                                ...
                                TOCOURSE:
                                    ...
                                    if (course[s].Equals("Secondary Education", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Elementary Education", StringComparison.InvariantCultureIgnoreCase))
                                    ...
                                    else if (course[s].Equals("Business Administration", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Information Technology", StringComparison.InvariantCultureIgnoreCase))
                                ...
                                //Bontoc
                                else if (campus[s].Equals("Bontoc", StringComparison.InvariantCultureIgnoreCase))
                                {
                                ...
                                BCCOURSE:
                                    ...
                                    if (course[s].Equals("Fisheries", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Information Technology", StringComparison.InvariantCultureIgnoreCase))
                                    ...
                                    else if (course[s].Equals("Marine Biology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Agriculture and Technology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else
                                ...
                                //San Juan
                                else if (campus[s].Equals("San Juan", StringComparison.InvariantCultureIgnoreCase))
                                {
                                ...
                                SJCOURSE:
                                    ...
                                    if (course[s].Equals("Industrial Technology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Secondary Education", StringComparison.InvariantCultureIgnoreCase))
                                    ...
                                    else if (course[s].Equals("Entrepreneurship", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Information Technology", StringComparison.InvariantCultureIgnoreCase))
                                    ...
                                    else if (course[s].Equals("Office Administration", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Accountancy", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Technology and Livelihood Education", StringComparison.InvariantCultureIgnoreCase))
                                    ...
                                    else if (course[s].Equals("Management Accounting", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else
                                ...
                                else if (campus[s].Equals("Maasin City", StringComparison.InvariantCultureIgnoreCase))
                                {
                                ...
                                MaasinCOURSE:
                                    ...
                                    if (course[s].Equals("Social Work", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[s].Equals("Public Administration", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else
                            ...
                            Console.ForegroundColor = ConsoleColor.Green;
                            Console.Write("\n\t\tChanging course updated successfully.");
                            Console.ResetColor();
                            Console.ForegroundColor=ConsoleColor.Cyan;
                            Console.Write(" Goodluck!\n\n");
                            Console.ResetColor();
