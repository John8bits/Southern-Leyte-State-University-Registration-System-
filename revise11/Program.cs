                        ...
                        if (AskShift == "y" || AskShift == "Y")
                        {
                           ...
                           Console.WriteLine("\n\t\tYour choosen course: {0}", course[s]);
                            ...
                            for (int k=0;k<x;k++)
                            {
                                ...
                                if (campus[k].Equals("Main", StringComparison.InvariantCultureIgnoreCase) || campus[k].Equals("Sogod", StringComparison.InvariantCultureIgnoreCase))
                                {
                                    k++;

                                MCCOURSE:
                                    Console.Write("\n\n\t\t\tEnter your updated course: ");
                                    course[k] = Console.ReadLine();

                                    if ( course[k].Equals("Information Technology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if ( course[k].Equals("Industrial Technology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if ( course[k].Equals("Technology and Livelihood Education", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if ( course[k].Equals("Industrial Technology", StringComparison.InvariantCultureIgnoreCase))
                                    ...
                                    else if ( course[k].Equals("Elementary Education", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if ( course[k].Equals("Civil Engineering", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if ( course[k].Equals("Computer Engineering", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[k].Equals("Criminology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if ( course[k].Equals("Electrical Engineering", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[k].Equals("Food Technology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[k].Equals("Tourism Management", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else
                                ...
                                //hinunangan campus
                                else if (campus[k].Equals("Hinunangan", StringComparison.InvariantCultureIgnoreCase))
                                {
                                    k++;
                                HCCOURSE:
                                    Console.Write("\n\n\t\t\tEnter your updated course: ");
                                    ...
                                    else if (course[k].Equals("Agricultural Technology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[k].Equals("Secondary Education", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[k].Equals("Technology and Livelihood Education", StringComparison.InvariantCultureIgnoreCase))
                                    ...
                                    else if (course[k].Equals("Agribusiness", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[k].Equals("Agriculture", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[k].Equals("Agricultural Entrepreneurship", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[k].Equals("Environmental Science", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[k].Equals("Information Technology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else
                                ...
                                //TO CAMPUS
                                else if (campus[k].Equals("Tomas Oppus", StringComparison.InvariantCultureIgnoreCase))
                                {
                                    k++;
                                TOCOURSE:
                                    Console.Write("\n\n\t\t\tEnter your updated course: ");
                                    ...
                                    if (course[k].Equals("Secondary Education", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[k].Equals("Elementary Education", StringComparison.InvariantCultureIgnoreCase))
                                    ...
                                    else if (course[k].Equals("Business Administration", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[k].Equals("Information Technology", StringComparison.InvariantCultureIgnoreCase))
                                ...
                                //Bontoc
                                else if (campus[k].Equals("Bontoc", StringComparison.InvariantCultureIgnoreCase))
                                {
                                    k++;
                                BCCOURSE:
                                    Console.Write("\n\n\t\t\tEnter your updated course: ");
                                    ...
                                    if (course[k].Equals("Fisheries", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[k].Equals("Information Technology", StringComparison.InvariantCultureIgnoreCase))
                                    ...
                                    else if (course[k].Equals("Marine Biology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[k].Equals("Agriculture and Technology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else
                                ...
                                //San Juan
                                else if (campus[k].Equals("San Juan", StringComparison.InvariantCultureIgnoreCase))
                                {
                                    k++;
                                SJCOURSE:
                                    Console.Write("\n\n\t\t\tEnter your updated course: ");
                                    ...
                                    if (course[k].Equals("Industrial Technology", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[k].Equals("Secondary Education", StringComparison.InvariantCultureIgnoreCase))
                                    ...
                                    else if (course[k].Equals("Entrepreneurship", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[k].Equals("Information Technology", StringComparison.InvariantCultureIgnoreCase))
                                    ...
                                    else if (course[k].Equals("Office Administration", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if ( course[k].Equals("Accountancy", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if ( course[k].Equals("Technology and Livelihood Education", StringComparison.InvariantCultureIgnoreCase))
                                    ...
                                    else if ( course[k].Equals("Management Accounting", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else
                                ...
                                else if (campus[k] != null && campus[k].Equals("Maasin City", StringComparison.InvariantCultureIgnoreCase))
                                {
                                    k++;
                                MaasinCOURSE:
                                    Console.Write("\n\n\t\t\tEnter your updated course: ");
                                    ...
                                    if ( course[k].Equals("Social Work", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else if (course[k].Equals("Public Administration", StringComparison.InvariantCultureIgnoreCase))
                                    {
                                        break;
                                    }
                                    else
